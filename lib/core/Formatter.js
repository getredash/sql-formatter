...
var Formatter = (function () {
    ...
    Formatter.prototype.getFormattedQueryFromTokens = function getFormattedQueryFromTokens() {
        ...
        this.tokens.forEach(function (token, index) {
            ...
            if (token.type === _tokenTypes2["default"].WHITESPACE) {
                ...
                token.type === _tokenTypes2["default"].RESERVED_TOPLEVEL
            ) {
                ...
                token.type === _tokenTypes2["default"].RESERVED_NEWLINE
            ) {
    ...
    Formatter.prototype.formatOpeningParentheses = function formatOpeningParentheses(
        ...
        // Take out the preceding space unless there was whitespace there in the
        // original query or another opening parens or line comment
    ...
    // Commas start a new line (unless within inline parentheses or SQL "LIMIT"
    // clause)
    ...
    Formatter.prototype.previousNonWhitespaceToken = function previousNonWhitespaceToken() {
        var n = 1;
        while (
            this.previousToken(n).type === _tokenTypes2["default"].WHITESPACE
        ) {
            n++;
        }
